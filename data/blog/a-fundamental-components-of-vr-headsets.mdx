...
Defining **Virtual Reality (VR)** has been proven as a difficult task because there is no standard definition for it. It is said to be an oxymoron, as it is referred to some as **"reality that does not exist"**.
...
**Depth of vision** should also be a concern to all VR [developers](https://www.42interactive.com/services/creative-technology-consultancy). UI elements in VR should match the **comfort zone** of all users in general. The object's movement should always be displayed in a **constant speed**. A sudden acceleration can make users feel uncomfortable.
